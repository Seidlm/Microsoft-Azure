...
$VMname = "Name of VM"
$subscriptionId = 'Subscription ID of VM'


#Action
$Action="deallocate" #powerOff, deallocate, start, restart
...
#Script
$URL_Action = "https://management.azure.com/subscriptions/$subscriptionId/resourceGroups/$ResourceGroupName/providers/Microsoft.Compute/virtualMachines/$($VMname)/$($Action)?api-version=$apiversion"
Invoke-RestMethod -Method POST -URI $URL_Action -headers $headers
